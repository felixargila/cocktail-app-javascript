  ...
  drinks: [
    {
      ...
      strInstructionsFR: "Verser la vodka, le vermouth sec et la saumure d'olive dans un shaker avec une poignée de glace et bien secouer.\r\nFrotter le bord d'un verre à martini avec le quartier de citron.\r\nFiltrer le contenu du shaker dans le verre et ajouter l'olive.\r\nUn dirty Martini contient un peu de saumure d'olive ou de jus d'olive et est généralement décoré d'une olive.",
